...
public class Menu {
    ...
    public static void addNewHolisticStudent(){
        ...
        HolisticStudentController holisticStudentWrite = new HolisticStudentController();      
        ...
        HolisticLegalGuardianController holisticLegalGuardianWrite = new HolisticLegalGuardianController();
    ...
    public void addNewHomeShoolStudent(){
        HomeStudentController registerStudent = new HomeStudentController();
        StudentCourseController studentListWrite = new StudentCourseController();
