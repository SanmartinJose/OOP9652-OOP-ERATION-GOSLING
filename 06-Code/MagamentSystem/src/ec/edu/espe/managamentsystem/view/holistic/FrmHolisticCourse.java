 ...
 * @author PabloEZurita
 */
public class FrmHolisticCourse extends javax.swing.JFrame {

    /**
     * Creates new form FrmCourse
     */
    public FrmHolisticCourse() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmHolisticCourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmHolisticCourse().setVisible(true);
            }
        });
    }
